...
def process_image(img):
    ...
    curve_centers = tracker(Mywindow_width = window_width, Mywindow_height = window_height, Mymargin = 25, My_ym = 30/720, My_xm = 4/384, Mysmooth_factor = 15)
    ...
    graphic_measure = cv2.addWeighted(warpage, 1, template, 0.5, 0.0)
    ...
    cv2.fillPoly(road,[inner_lane],color=[40, 220, 220])
